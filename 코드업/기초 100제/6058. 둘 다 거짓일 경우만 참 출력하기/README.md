# [기초-논리연산] 둘 다 거짓일 경우만 참 출력하기(py) - 6058
...
<br />
2개의 정수값이 입력될 때&#44; <br />
그 불 값(True/False) 이 모두 False 일 때에만 True 를 출력하는 프로그램을 작성해보자. <br />
<p style="text-align:right;">
	<img src="/admin/../upload/pimg6223_1.png" alt="" /> <br />
<br />
<br />
...
두 값의 True / False 값이 모두 False 일 때만 True 를 출력하고&#44; 그 외의 경우에는 False 를 출력한다. <br />
<br />
