# [기초-비트단위논리연산] 비트단위로 OR 하여 출력하기(설명)(py) - 6061

[문제 링크](https://codeup.kr/problem.php?id=6061)
...
비트단위(bitwise) 연산자 |(or&#44; vertical bar&#44; 버티컬바)를 사용하면 된다.<br />
<br />
** | 은 파이프(pipe)연산자라고도 불리는 경우가 있다.<br />
<br />
...
이 된다.<br />
<br />
비트단위 or 연산은 둘 중 하나라도 1인 자리를 1로 만들어주는 것과 같다.<br />
<br />
이러한 비트단위 연산은 빠른 계산이 필요한 그래픽처리에서도 효과적으로 사용된다. <br />
<p style="text-align:right;">
	<img src="/admin/../upload/pimg6226_1.png" alt="" /> <br />
<br />
<br />
...
두 정수를 비트단위(bitwise)로 or 계산을 수행한 결과를 10진수로 출력한다. <br />
<br />
